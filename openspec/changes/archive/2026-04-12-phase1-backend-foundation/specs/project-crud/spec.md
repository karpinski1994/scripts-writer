...
Defines the database persistence layer (SQLAlchemy + SQLite), Alembic migrations, project CRUD API endpoints, Pydantic request/response schemas, service layer, and test infrastructure for the Scripts Writer backend.
